    ...
    <div className="min-h-screen bg-background">
      <header className="border-b border-border">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold">Virtual Try-On 2</h1>
            <p className="text-xs text-muted-foreground">Advanced testing version</p>
          </div>
            ...
            <Card className="p-3 bg-card shadow-[var(--shadow-soft)]">
              ...
              <div className="space-y-3">
                ...
                <div className="pt-2 border-t border-border">
                  <p className="text-xs font-medium mb-2 text-muted-foreground">Mask Image (Optional)</p>
                  <ImageUploadZone
